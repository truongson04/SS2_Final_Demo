...
export const sendOTP = async (req, res)=>{
     ...
     if(!userCheck && ! req.body.newCheck){
      return res.status(404).json({message:"Your email is invalid, please recheck it"})
     }
  ...
  let otp= "";
    ...
    return res.status(200).json({message:'An OTP code has been sent to your email. Please check it, even with your spam letter'})
    } catch (error) {
