<template>
    <footer class="bg-black text-slate-300 border-t border-white/10 pt-16 pb-8">
    <div class="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            
            <div class="lg:col-span-1">
                <a href="#" class="flex items-center gap-2 mb-6">
                    <div class="h-8 w-8 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-md flex items-center justify-center font-bold text-white text-sm">CV</div>
                    <span class="font-bold text-xl tracking-tight text-white">CVBuilder</span>
                </a>
                <p class="text-sm text-slate-500 mb-6">
                    Build your future, one resume at a time. Join our newsletter for career tips.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="#" class="hover:text-cyan-400 transition">Templates</a></li>
                    <li><a href="#" class="hover:text-cyan-400 transition">AI Analysis</a></li>
                    <li><a href="#" class="hover:text-cyan-400 transition">Pricing</a></li>
                    <li><a href="#" class="hover:text-cyan-400 transition">Chrome Extension</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="#" class="hover:text-cyan-400 transition">Career Blog</a></li>
                    <li><a href="#" class="hover:text-cyan-400 transition">Resume Examples</a></li>
                    <li><a href="#" class="hover:text-cyan-400 transition">Cover Letter Builder</a></li>
        ...
        <div class="border-t border-slate-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-xs text-slate-600">
                &copy; 2024 CVBuilder Inc. All rights reserved.
            </p>
