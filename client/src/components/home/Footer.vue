    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
        <div class="lg:col-span-1">
          ...
          <p class="text-sm text-slate-500 mb-6 mt-6">
            Build your future, one resume at a time. Join our newsletter for
            career tips.
          </p>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-3 text-sm">
            <li>
              <a href="#" class="hover:text-cyan-400 transition">Templates</a>
            </li>
            <li>
        ...
        <div>
          ...
          <ul class="space-y-3 text-sm">
            <li>
              <a href="#" class="hover:text-cyan-400 transition">Career Blog</a>
            </li>
            <li>
              <a href="#" class="hover:text-cyan-400 transition"
                >Resume Examples</a
            ...
            <li>
              <a href="#" class="hover:text-cyan-400 transition">Help Center</a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-3 text-sm">
            <li>
              <a href="#" class="hover:text-cyan-400 transition">About Us</a>
            </li>
            <li>
      ...
      <div
        class="border-t border-slate-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4"
      >
        <p class="text-xs text-slate-600">
          &copy; 2026 CVBuilder Inc. All rights reserved.
        </p>
