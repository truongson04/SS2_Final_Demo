    ...
    >
      ...
      >
        ...
        <p
          ...
          class="text-xl font-medium text-gray-600 mb-4 uppercase prose prose-sm max-w-none"
      ...
      <div class="space-y-5">
        <div v-for="(exp, index) in data.experience" :key="index">
          ...
          <div
            ...
            class="text-gray-700 text-sm leading-relaxed pl-1 prose prose-sm max-w-none"
        ...
        <div v-for="(proj, index) in data.project" :key="index">
          <div class="flex justify-between items-baseline mb-1">
            ...
            <a
              ...
              :href="proj.link"
              target="_blank"
              class="text-xs font-medium flex items-center gap-1 hover:underline"
              :style="{ color: accentColor }"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="space-y-4">
          <div v-for="(edu, index) in data.education" :key="index">
            ...
            <div
              ...
              class="text-gray-700 text-sm mt-2 prose prose-sm max-w-none"
